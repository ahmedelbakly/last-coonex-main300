...
function createData(id, DomainName, status, creationDate, actions) {
  return {
    id,
    DomainName,
    status,
...
const rows = [
  createData(1, "prim.youcan.store", "verified", "12/2/2023, 08:00 PM"),
  createData(2, "prim.youcan.store", "pending", "12/2/2023, 08:00 PM"),
  createData(3, "prim.youcan.store", "verified", "12/2/2023, 08:00 PM"),
];
                    ...
                    <TableCell align="left">
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: "8px",
                          color: `${
                            row.status === "pending" ? "#DB6F12" : "#109351"
                          }`,
                        }}
                      >
                        {row.status}
